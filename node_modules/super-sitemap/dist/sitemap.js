 ...
 * ```
 */
export async function response({ additionalPaths = [], defaultChangefreq, defaultPriority, excludeRoutePatterns, headers = {}, lang, maxPerPage = 50_000, origin, page, paramValues, processPaths, sort = false, }) {
 ...
 */
export function generateBody(origin, pathObjs) {
 ...
 */
export function generatePaths({ defaultChangefreq, defaultPriority, excludeRoutePatterns = [], lang = { default: "en", alternates: [] }, paramValues = {}, }) {
 ...
 */
export function generatePathsWithParamValues(routes, paramValues, defaultChangefreq, defaultPriority) {
 ...
 */
export function processOptionalParams(originalRoute) {
 ...
 * @private
 */
export function processPathsWithLang(pathObjs, langConfig) {
    if (!pathObjs.length)
        return [];
 ...
 * @private
 */
export function generateAdditionalPaths({ additionalPaths, defaultChangefreq, defaultPriority, }) {
    const defaults = {
        changefreq: defaultChangefreq,
        lastmod: undefined,
        priority: defaultPriority,
